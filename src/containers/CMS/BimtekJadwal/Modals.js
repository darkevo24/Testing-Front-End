...
export const Modals = ({ statusModal, visible, onSubmit, listMateri, idMateri, removeFile, addFile, control, errors }) => {
  ...
  switch (statusModal) {
    case 'proses':
      return <CMSModal onClose={visible} label="Simpan Jadwal Bimtek?" confirmButtonAction={onSubmit} />;
    case 'materi':
      return (
