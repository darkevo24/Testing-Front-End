        ...
        <div>
          <div className="d-flex justify-content-between mb-4">
            <div className={bem.e('title')}>
              Permintaan Bimbingan Teknis Baru
            </div>
            <div>
              <Button className="ml-10" variant="secondary" style={{width: "112px"}}>Tolak</Button>
              <Button className="ml-10" variant="info" style={{width: "112px"}}>Setujui</Button>
            </div>
          </div>
